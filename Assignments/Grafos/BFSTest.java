...
class BFSTest {
    ...
    void breadthFirstSearchUndirected1() {
        int n = 9;
        ...
        int[] expected = new int[]{1, 2, 4, 8, 3, 7, 9, 5, 6};
        List<Integer> traversals = BFS.breadthFirstSearch(g, 1);
    ...
    void depthFirstSearchDirected() {
        ...
        int[] expected = new int[]{1, 2, 4, 8, 3, 7};
        List<Integer> traversals = BFS.breadthFirstSearch(g, 1);
